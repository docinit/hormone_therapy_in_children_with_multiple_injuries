N.B.! Для просмотра работы с цветовым оформлением таблиц скачайте файл .html
...
Данное приложение (код на Python), файлы и проведенный статистический анализ позволяют
